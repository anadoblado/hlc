            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="crearAlquilerUsuario" method="post">
                            <div class="form-group">
                                <label>Tu id: </label>
                                <input class="form-control" type="text" name="idusuario" value="<% out.println(session.getAttribute("id"));%>" readonly>
                            </div>
                            <div class="form-group">
