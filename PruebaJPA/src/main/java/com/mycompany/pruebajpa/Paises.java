...
@NamedQueries({
    ...
    @NamedQuery(name = "Paises.findByName", query = "SELECT p FROM Paises p WHERE p.name = :name"),
    @NamedQuery(name = "Paises.deleteById", query = "Delete from Paises p where p.id = :id")})
public class Paises implements Serializable {
    ...
    public Paises(Long id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public String toString() {
        return "com.mycompany.pruebajpa.Paises[ id=" + id + " ]";
    }
